...
public class EmpCardItem {
    ...
    public EmpCardItem(String jobTitle, String startTime, String endTime, String date,
                    String pay, String location, String description, String filled, String offerSent,
                    String spotterUid, String shiftId){
